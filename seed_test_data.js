...
const posts = [
    // MODIFICATION: Removed media_type, kept media_url
    { userIndex: 0, content: 'Morning light in the studio is hitting different today. Feeling that creative flow.', vibe_channel_tag: 'flow', created_at: new Date('2025-09-24T09:15:00Z').toISOString(), media_url: 'https://images.pexels.com/photos/3225517/pexels-photo-3225517.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { userIndex: 8, content: 'My tomatoes are finally starting to ripen! It’s the little things.', vibe_channel_tag: 'joy', created_at: new Date('2025-09-24T11:30:00Z').toISOString(), media_url: null },
    { userIndex: 6, content: 'Early morning writing session fueled by coffee and inspiration. #amwriting', vibe_channel_tag: 'flow', created_at: new Date('2025-09-24T07:05:00Z').toISOString(), media_url: null },
    { userIndex: 20, content: 'Sunrise run to start the day. Let\'s get it!', vibe_channel_tag: 'hype', created_at: new Date('2025-09-24T06:20:00Z').toISOString(), media_url: 'https://videos.pexels.com/video-files/854061/854061-hd.mp4' },
    { userIndex: 13, content: 'Starting the day with a moment of gratitude. Sending warmth to you all.', vibe_channel_tag: 'warmth', created_at: new Date('2025-09-24T08:45:00Z').toISOString(), media_url: null },
    { userIndex: 24, content: 'A quiet moment of reflection before the day begins. What are you thankful for?', vibe_channel_tag: 'reflect', created_at: new Date('2025-09-24T05:55:00Z').toISOString(), media_url: null },
    { userIndex: 9, content: 'Perfecting this fall look. It\'s all about the layers and textures.', vibe_channel_tag: 'glow', created_at: new Date('2025-09-24T10:10:00Z').toISOString(), media_url: 'https://images.pexels.com/photos/375880/pexels-photo-375880.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { userIndex: 4, content: 'If you haven\'t tried the tacos at Sabor, you are missing out! The flavor is pure joy.', vibe_channel_tag: 'joy', created_at: new Date('2025-09-24T13:30:00Z').toISOString(), media_url: 'https://images.pexels.com/photos/461198/pexels-photo-461198.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { userIndex: 1, content: 'On the hunt for the best locations for a new documentary. The city has so much character.', vibe_channel_tag: 'flow', created_at: new Date('2025-09-24T15:00:00Z').toISOString(), media_url: null },
    { userIndex: 15, content: 'Really proud of how this new feature is coming together. The team is killing it.', vibe_channel_tag: 'glow', created_at: new Date('2025-09-24T16:45:00Z').toISOString(), media_url: null },
    { userIndex: 3, content: 'Deep in the code, building the future. This new framework is a game changer.', vibe_channel_tag: 'flow', created_at: new Date('2025-09-24T14:20:00Z').toISOString(), media_url: null },
    { userIndex: 12, content: 'Found the most amazing spot for a weekend getaway. Can\'t wait to share more pics!', vibe_channel_tag: 'joy', created_at: new Date('2025-09-24T17:50:00Z').toISOString(), media_url: 'https://images.pexels.com/photos/2387873/pexels-photo-2387873.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { userIndex: 18, content: 'New mural I just finished downtown. Art is love, love is art.', vibe_channel_tag: 'love', created_at: new Date('2025-09-24T12:15:00Z').toISOString(), media_url: 'https://images.pexels.com/photos/1616470/pexels-photo-1616470.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { userIndex: 16, content: 'Trying out a new sustainable fashion brand. This color is everything!', vibe_channel_tag: 'glow', created_at: new Date('2025-09-24T14:55:00Z').toISOString(), media_url: null },
    { userIndex: 22, content: 'Finally perfected my sourdough recipe. The warmth of a fresh loaf is unmatched.', vibe_channel_tag: 'warmth', created_at: new Date('2025-09-24T17:10:00Z').toISOString(), media_url: null },
    { userIndex: 1, content: 'Just dropped a new short film on my site! Hope it brings some hype to your weekend.', vibe_channel_tag: 'hype', created_at: new Date('2025-09-24T21:00:00Z').toISOString(), media_url: 'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4' },
    { userIndex: 2, content: 'Quiet evening reflecting on the week. Sending love to everyone out there.', vibe_channel_tag: 'reflect', created_at: new Date('2025-09-24T22:30:00Z').toISOString(), media_url: null },
    { userIndex: 7, content: 'New mix is live! A full hour of non-stop energy to get you through the week. #DJ #Hype', vibe_channel_tag: 'hype', created_at: new Date('2025-09-24T19:00:00Z').toISOString(), media_url: null },
    { userIndex: 10, content: 'There\'s nothing like the warmth of a vintage synth sound. Working on something new.', vibe_channel_tag: 'warmth', created_at: new Date('2025-09-24T20:45:00Z').toISOString(), media_url: 'https://images.pexels.com/photos/164821/pexels-photo-164821.jpeg?auto=compress&cs=tinysrgb&w=600' },
    { userIndex: 13, content: 'Just finished a sunset yoga session. So much love for this community.', vibe_channel_tag: 'love', created_at: new Date('2025-09-24T18:10:00Z').toISOString(), media_url: null },
    { userIndex: 21, content: 'Late night edit session for the next short film. The story is finally coming together.', vibe_channel_tag: 'flow', created_at: new Date('2025-09-25T01:30:00Z').toISOString(), media_url: null },
    { userIndex: 19, content: 'Nothing like a late-night recording session when the inspiration hits. #music', vibe_channel_tag: 'hype', created_at: new Date('2025-09-25T03:00:00Z').toISOString(), media_url: null },
    { userIndex: 11, content: 'Just wrapped up a long design session. Seeing a concept come to life is the best feeling.', vibe_channel_tag: 'glow', created_at: new Date('2025-09-24T23:45:00Z').toISOString(), media_url: null },
    { userIndex: 17, content: 'Sometimes you just have to look at the stars and reflect.', vibe_channel_tag: 'reflect', created_at: new Date('2025-09-25T04:20:00Z').toISOString(), media_url: 'https://images.pexels.com/photos/1252890/pexels-photo-1252890.jpeg?auto=compress&cs=tinysrgb&w=600' },
];
...
async function seed() {
  ...
  try {
    ...
    // ... seeding users remains the same ...
    ...
    for (const post of posts) {
      ...
      // MODIFICATION: Removed media_type from the INSERT statement
      const res = await query(
        'INSERT INTO posts (user_id, content, vibe_channel_tag, created_at, media_url) VALUES ($1, $2, $3, $4, $5) RETURNING id',
        [userId, post.content, post.vibe_channel_tag, post.created_at, post.media_url]
      );
